...
module.exports = function (log, error) {
  ...
  Memory.prototype.createAccount = function (uid, data) {
    ...
    if (data.ssoId) {
      if (uidBySSO[data.ssoId]) {
        return P.reject(error.duplicate())
      }
      uidBySSO[data.ssoId] = uid
    }
  ...
  Memory.prototype.ssoRecord = function (ssoId) {
    var uid = uidBySSO[ssoId.toString('utf8')]
